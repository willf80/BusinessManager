<form class="inbox-compose form-horizontal" id="fileupload" action="#" method="POST" enctype="multipart/form-data">
	...
	<div class="inbox-control-group mail-to">
		...
		<div class="controls controls-to">
			<input type="hidden" class="m-wrap span12 tags-input" name="to" value="fiona.stone@arthouse.com, lisa.wong@pixel.com, jhon.doe@gmail.com">
	...
	<div class="inbox-control-group input-cc">
		...
		<div class="controls controls-cc">
			<input type="hidden" name="cc" class="m-wrap span12 tags-input" value="jhon.doe@gmail.com, kevin.larsen@gmail.com">
		</div>
	</div>
	...
	<div class="inbox-control-group">
		...
		<div class="controls">
			<input type="hidden" class="m-wrap span12 tags-input" name="subject" value="Urgent - Financial Report for May, 2013">
		</div>
	</div>
	<div class="inbox-control-group">
